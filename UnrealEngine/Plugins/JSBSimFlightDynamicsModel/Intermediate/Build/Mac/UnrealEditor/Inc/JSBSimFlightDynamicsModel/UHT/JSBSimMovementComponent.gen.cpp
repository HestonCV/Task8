...
void FDelegateAircraftCrashed_DelegateWrapper(const FMulticastScriptDelegate& DelegateAircraftCrashed)
{
	...
	struct Z_CompiledInDeferFile_FID_heston_repos_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_JSBSimMovementComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_heston_repos_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_JSBSimMovementComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_heston_repos_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_JSBSimMovementComponent_h_2555890303(TEXT("/Script/JSBSimFlightDynamicsModel"),
		Z_CompiledInDeferFile_FID_heston_repos_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_JSBSimMovementComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_heston_repos_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_JSBSimMovementComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
